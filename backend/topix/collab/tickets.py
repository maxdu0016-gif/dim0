...
async def mint_ticket(redis_store: RedisStore, user_id: str, board_id: str) -> str:
    """Mint a short-lived ticket binding (user_id, board_id) for WS auth."""
    token = secrets.token_urlsafe(32)
    payload = json.dumps({"user_id": user_id, "board_id": board_id})
