...
export function CodeSandboxView({ id }: CodeSandboxViewProps) {
  ...
  return (
    <div
      className={cn(
        "flex h-full w-full flex-col overflow-hidden rounded-md border border-border bg-stone-900 text-stone-100",
    ...
    >
      ...
      <pre className="flex-1 overflow-hidden whitespace-pre p-2 font-mono text-[11px] leading-relaxed text-stone-300">
