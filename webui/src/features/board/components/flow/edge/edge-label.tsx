      ...
      >
        {isEditing ? (
          <TextareaAutosize
            ...
            className={`text-center text-base px-2 py-1 bg-card rounded-md border-2 border-secondary-foreground focus:outline-none min-w-[160px] resize-none max-w-[200px] overflow-y-hidden ${fontFamilyClass}`}
            minRows={1}
            maxRows={4}
