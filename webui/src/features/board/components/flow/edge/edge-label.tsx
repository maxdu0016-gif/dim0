      ...
      >
        {isEditing ? (
          <TextareaAutosize
            ...
            className={`z-[1002] text-center text-base px-0 py-0.5 bg-card rounded-md border-2 border-secondary-foreground focus:outline-none min-w-[60px] resize-none max-w-[200px] overflow-y-hidden ${fontFamilyClass}`}
            minRows={1}
            maxRows={4}
          ...
          <div
            className={`text-center bg-transparent text-base text-card-foreground max-w-[200px] p-0 ${fontFamilyClass}`}
            style={{ color: labelColor ?? 'inherit' }}
          >
